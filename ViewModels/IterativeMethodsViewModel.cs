...
namespace KantorLr1.ViewModels
{
	public class IterativeMethodsViewModel : ContentControlViewModel
	{
		...
		public IterativeMethodsViewModel()
		{
			...
			AutoGenerateDataCommand = new LambdaCommand(OnAutoGenerateDataCommandExecuted, CanAutoGenerateDataCommandExecute);
		...
		public ICommand AutoGenerateDataCommand { get; }
		private void OnAutoGenerateDataCommandExecuted(object param)
		{

		}
		private bool CanAutoGenerateDataCommandExecute(object param)
		{
			return true;
		}
		#endregion
